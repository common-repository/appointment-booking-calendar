...
function cpabcal_feedback() {
    ...
    if (
		...
		wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['_wpnonce'] ) ), 'abc-feedback' )
	) {    
...
$(window).on('load',function () {
        document.querySelector('[data-slug="<?php echo esc_js($cpabcal_plugslug); ?>"] .deactivate a').addEventListener('click', function(event){
            event.preventDefault()
            var urlRedirect = document.querySelector('[data-slug="<?php echo esc_js($cpabcal_plugslug); ?>"] .deactivate a').getAttribute('href');
      		   ...
      		   '</div></div>'
                  ...
                  buttons: [
                        ...
                        click: function() {                               
                                   ...
                                   else
                                   {
                                       ...
                                       var data = {
                                            ...
                                            '_wpnonce' : '<?php echo esc_js(wp_create_nonce( 'abc-feedback' )); ?>',
                      ...
                      },
                      {
                        ...
                        click: function() {
                                   window.open('<?php echo esc_js($cpabcal_supportlink_full); ?>');
      						       $(this).dialog("close");
      				           }                            
                      },
                      {
