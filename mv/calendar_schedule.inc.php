...
<div id="normal-sortables" class="meta-box-sortables">
 <hr />
 <h3>Schedule for: <?php echo esc_html($mycalendarrows[0]->uname); ?></h3>
</div>
<p>The purpose of this page is to <strong>display the bookings/schedule in a calendar view</strong>. You can add bookings from the public booking form or <a href="?page=cpabc_appointments.php&cal=<?php echo intval(CP_CALENDAR_ID); ?>&addbk=1">add bookings from the dashboard</a> and the bookings will appear in this calendar.</p>
...
<div id="cpabc_printable_contents">                        
            ...
            <script type="text/javascript">
             var pathCalendar = "<?php echo esc_js(cpabc_appointment_get_site_url(true)); ?>/?cpabc_calendar_load2=1&id=<?php echo intval(CP_CALENDAR_ID); ?>&cpabc_action=mvparse";
             var dc_subjects = "";var dc_locations = "";
             initMultiViewCal("cal<?php echo intval(CP_CALENDAR_ID); ?>", <?php echo intval(CP_CALENDAR_ID); ?>,
          {viewDay:true,
          viewWeek:true,
          viewMonth:true,
          viewNMonth:true,
          ...
          userOwner:0 ,cellheight:62 , palette:0, paletteDefault:"F00", paletteFull:["FFF","FCC","FC9","FF9","FFC","9F9","9FF","CFF","CCF","FCF","CCC","F66","F96","FF6","FF3","6F9","3FF","6FF","99F","F9F","BBB","F00","F90","FC6","FF0","3F3","6CC","3CF","66C","C6C","999","C00","F60","FC3","FC0","3C0","0CC","36F","63F","C3C","666","900","C60","C93","990","090","399","33F","60C","939","333","600","930","963","660","060","366","009","339","636","000","300","630","633","330","030","033","006","309","303"]});
            ...
            <div id="multicalendar"><div id="cal<?php echo intval(CP_CALENDAR_ID); ?>" class="multicalendar"></div></div>
