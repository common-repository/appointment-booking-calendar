...
if ( 'POST' == $_SERVER['REQUEST_METHOD'] && isset( $_POST['cpabc_appointments_post'] ) )
    echo '<div id="setting-error-settings_updated" class="updated settings-error"><p><strong>Booking added. It appears now in the <a href="?page='.esc_attr($plugslug).'&cal='.intval(CP_CALENDAR_ID).'&list=1">bookings list</a>.</strong></p></div>';
